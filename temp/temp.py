...
def parse_arg():
    ...
    parser.add_argument('--target', help='for test')
    args = parser.parse_args()
    return args
def main():
    args = parse_arg()
    print("{}  {}".format(args.target, args.target))
...
if __name__ == "__main__":
    ...
    # D:\\Lane\\weight_file\\2021_08_24\\epoch_15_index_0.pth
    # D:\\lane_dataset\\train_set\\clips\\0313-1\\660\\20.jpg
