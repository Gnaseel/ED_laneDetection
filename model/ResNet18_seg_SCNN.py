...
class ResNet18_seg_SCNN(torch.nn.Module):
    def __init__(self):
        super(ResNet18_seg_SCNN, self).__init__()
        self.maxArg=8
        ...
        self.dim_set = torch.nn.Conv2d(512, 128, kernel_size=1, stride = 1, padding = 0)
        self.dim_set_re = torch.nn.Conv2d(128, 512, kernel_size=1, stride = 1, padding = 0)
